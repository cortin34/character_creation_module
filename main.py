...
def attack(char_name: str, char_class: str) -> str:
    """Выполняет атаку и возвращает сообщение об атаке."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выполняет защиту и возвращает сообщение о защите."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Выполняет специальное умение и возвращает сообщение
    о специальном умении.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Запускает тренировку и возвращает сообщение о ее окончании."""
    if char_class == 'warrior':
